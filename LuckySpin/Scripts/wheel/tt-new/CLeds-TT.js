function CLeds (iX, iY){
    ...
    this._init = function(iX, iY){    
        ...
        var oData = {   // image to use
                        ...
                        frames: {width: 70, height: 70, regX: 35, regY: 35}, 
                        animations: { off: [0], white: [1], green: [2], blue: [3], violet: [4], red: [5], yellow: [6]}
                        
        };
        var oSpriteSheet = new createjs.SpriteSheet(oData);        
        
        var oStartLedPos = {x: 395, y: 65};
        var vVect = new CVector2(oStartLedPos.x, oStartLedPos.y);
        var iRotation =  (Math.PI*(360/KASCKLNALKCN.length))/180;
                
        for(var i=0; i<KASCKLNALKCN.length; i++ ){
            _aLeds[i] = createSprite(oSpriteSheet,"white",0,0,iLedWidth,iLedHeight);            
    ...
    this.animIdle1 = function(){
        ...
        if(_iTimeElaps === 0){
            _iCurLed = 0;
            _aLeds[_iCurLed].gotoAndStop("yellow");
            _aLeds[_aLeds.length/4].gotoAndStop("yellow");
            _aLeds[_aLeds.length/2].gotoAndStop("yellow");
            _aLeds[_aLeds.length*3/4].gotoAndStop("yellow");
        ...
        if(_iTimeElaps > ANIM_IDLE2_TIMESPEED){
            ...
            if(_iCurLed === 0){
                _aLeds[_aLeds.length-1].gotoAndStop("yellow");
                _aLeds[0].gotoAndStop("off");
                
                _aLeds[_aLeds.length/4-1].gotoAndStop("yellow");
                _aLeds[_aLeds.length/4].gotoAndStop("off");
                
                _aLeds[_aLeds.length/2-1].gotoAndStop("yellow");
                _aLeds[_aLeds.length/2].gotoAndStop("off");
                
                _aLeds[_aLeds.length*3/4-1].gotoAndStop("yellow");
                _aLeds[_aLeds.length*3/4].gotoAndStop("off");
                
            }  else {
                _aLeds[_iCurLed-1].gotoAndStop("yellow");
                _aLeds[_iCurLed].gotoAndStop("off");
                
                _aLeds[_aLeds.length/4 + _iCurLed-1].gotoAndStop("yellow");
                _aLeds[_aLeds.length/4 + _iCurLed].gotoAndStop("off");
                
                _aLeds[_aLeds.length/2 + _iCurLed-1].gotoAndStop("yellow");
                _aLeds[_aLeds.length/2 + _iCurLed].gotoAndStop("off");
                
                _aLeds[_aLeds.length*3/4 + _iCurLed-1].gotoAndStop("yellow");
                _aLeds[_aLeds.length*3/4 + _iCurLed].gotoAndStop("off");                
            }
    ...
    this.animIdle2 = function (){
        ...
        if(_iTimeElaps === 0){
            ...
            _aLeds[_iCurLed].gotoAndStop("yellow");
            _aLeds[_iCurLed2].gotoAndStop("yellow");
        }
        ...
        if(_iTimeElaps > ANIM_IDLE3_TIMESPEED){
            ...
            if(_iCurLed === 0){
                _aLeds[_aLeds.length-1].gotoAndStop("yellow");
                _aLeds[1].gotoAndStop("yellow");
                _aLeds[0].gotoAndStop("yellow");
                ...
                if(_iCurLed !== 1){
                        _aLeds[_aLeds.length - _iCurLed + 1].gotoAndStop("yellow");
                    }                    
                _aLeds[_aLeds.length - _iCurLed].gotoAndStop("off");              


                _aLeds[_iCurLed2 + 1].gotoAndStop("yellow");
                _aLeds[_iCurLed2].gotoAndStop("off");

                _aLeds[_aLeds.length - _iCurLed2 -1].gotoAndStop("yellow");
                if(_iCurLed2 !== 0){
                    _aLeds[_aLeds.length - _iCurLed2].gotoAndStop("off");
                }
