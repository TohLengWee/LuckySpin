function CHelpPanel4(){
    ...
    this._init = function(){
        var oParent = this;
        _oHelpBg = createBitmap(s_oSpriteLibrary.getSprite('bg_help4'));
        _oGroup = new createjs.Container();

        var oText1Pos = {x: 1150, y: 625};
  
        _oText1 = new createjs.Text(xosandjxhgdaasd,"bold 60px Helvetica", "#ffffff");
        ...
        _oText1.lineWidth = 600;  
         ...
         var oText1Pos1 = {x: 995, y: 698};
  
        _oText1x = new createjs.Text(usidxx,"bold 35px Helvetica", "#fff400");
